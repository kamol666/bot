...
import { uzcardAuthHash } from '../../../shared/database/hashing/uzcard-auth-hash';
...
export class UzcardOnetimeApiService {
  ...
  async confirmPaymentWithoutRegistration(
    ...
    try {
      ...
      if (user) {
        // TODO: Add notification handling without circular dependency
        ...
        //   dto.selectedService,
        // );
        logger.info(`Payment success for uzcard user: ${user.telegramId}`);
      }
